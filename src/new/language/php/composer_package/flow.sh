...
run_composer_package_flow_docker() {
  ...
  source "${tool_dir}/src/new/language/php/composer_package/container/docker/compose/v1/compose.sh"
  # shellcheck source=./container/docker/dockerfile/v1/dockerfile.sh
  source "${tool_dir}/src/new/language/php/composer_package/container/docker/dockerfile/v1/dockerfile.sh"
  # shellcheck source=./container/docker/entrypoint/v1/entrypoint.sh
  source "${tool_dir}/src/new/language/php/composer_package/container/docker/entrypoint/v1/entrypoint.sh"
  # shellcheck source=./container/docker/configuration/index/v1/index.sh
  source "${tool_dir}/src/new/language/php/composer_package/container/docker/configuration/index/v1/index.sh"
  # shellcheck source=./container/docker/dev.sh
  source "${tool_dir}/src/new/language/php/composer_package/container/docker/dev.sh"
  ...
  setup_dev_index
  cp -f "${tool_dir}/src/new/language/php/composer_package/container/docker/doc/PROJECTINIT_README_v1.adoc" "${project_root_dir}/PROJECTINIT_README.adoc"
  build_dev
}